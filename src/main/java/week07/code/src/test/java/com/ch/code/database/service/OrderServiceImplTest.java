...
import com.ch.code.database.service.impl.OrderServiceImpl;
...
public class OrderServiceImplTest {
    ...
    public void testInsertAndQuery() {
        ...
        // 使用从库 slave1
        List<Map<String, Object>> entities = orderService.query(dataSourceCenter.getSlaveDataSource(), sql);
        for (Map item : entities) {
            System.out.println(item.toString());
        }

//        // 使用从库slave2
//        List<Map<String, Object>> slaveEntities = orderService.query(dataSourceCenter.getSlaveDataSource(), sql);
//        for (Map item : entities) {
//            System.out.println(item.toString());
//        }
    }
